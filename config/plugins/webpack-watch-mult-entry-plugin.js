// plugins/webpack-watch-mult-entry-plugin.js
...
class WebpackWatchedGlobEntries {
    ...
    static getEntries(globs, globOptions, pluginOptions_) {
      ...
      return function () {
          ...
          if (typeof globs === 'object') {
            ...
            // _globs.forEach(function (globString) {
            ...
            //     let files = WebpackWatchedGlobEntries.getFilesOfObject(globString, globOptions, pluginOptions.basename_as_entry_name);

            //     // Set the globbed files
            //     globbedFiles = Object.assign(files, globbedFiles);

            // });
        Object.entries(globs).forEach(function ([key, value]) {
              
                     let globBaseOptions = globBase(value);
                ...
                // Get the globbedFiles
                let files = WebpackWatchedGlobEntries.getFilesOfObject(key,value, globOptions, pluginOptions.basename_as_entry_name);
    ...
    static getFilesOfObject(key,globString, globOptions, basename_as_entry_name) {
        const files = {};
        const globBaseOptions = globBase(globString);
